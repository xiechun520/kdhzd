	...
	<view class="">
		...
		<view class="">
			<view class="card-menus">
				...
				<view class="flexs tabtype text-center margin-top-sm padding-bottom border-bottom">
					<view>
						<image src="../../static/phone/wfw.png" mode="aspectFit"></image>
						<text>未服务</text>
					</view>
					<view>
						<image src="../../static/phone/yfw.png" mode="aspectFit"></image>
						<text>已服务</text>
					</view>
					<view>
						<image src="../../static/phone/zzfw.png" mode="aspectFit"></image>
						<text>正在服务</text>
					</view>
					<view>
						<image src="../../static/phone/fwpj.png" mode="aspectFit"></image>
						<text>服务评价</text>
					</view>
					<view>
						<image src="../../static/phone/sh.png" mode="aspectFit"></image>
						<text>售后评价</text>
					</view>
				</view>
				<view class="fw-list">
